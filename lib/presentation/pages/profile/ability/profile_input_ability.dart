...
class _ProfileInputAbilityState extends State<ProfileInputAbility> {
  ...
  late AbilityCubit _abilityCubit;

  @override
  void initState() {
    _abilityCubit = AbilityCubit(ProfileUpdateAbilityRepositoryImpl());
    super.initState();
  }
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: BlocConsumer<AbilityCubit, AbilityState>(
            listener: (context, abilityState) {
              if (abilityState is AbilityIsSuccess) {
                context.goNamed(Routes.profileblankPage);
              } else if (abilityState is AbilityIsFailed) {
        ...
        bottomSheet: Container(
          ...
          child: ElevatedButton(
            onPressed: () {
              BlocProvider.of<AbilityCubit>(context).fetchProfileUpdateAbility(

...
class _ProfileInputBahasaState extends State<ProfileInputLanguage> {
  ...
  @override
  void initState() {
    _languageCubit = LanguageCubit(ProfileUpdateLanguageRepositoryImpl());
    super.initState();
  }
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: BlocConsumer<LanguageCubit, LanguageState>(
            listener: (context, languageState) {
              if (languageState is LanguageIsSuccess) {
                context.goNamed(Routes.profileblankPage);
              } else if (languageState is LanguageIsFailed) {
        ...
        bottomSheet: Container(
          ...
          child: ElevatedButton(
            onPressed: () {
              BlocProvider.of<LanguageCubit>(context).fetchProfileUpdateLanguage(ProfileUpdateLanguageRequest(
                [
                  _language1.text,
                  _language2.text,
                  _language3.text,
